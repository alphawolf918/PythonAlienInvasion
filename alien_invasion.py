...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.pygame_icon = pygame.transform.scale(pygame.image.load('images/ufo.png'), (self.settings.alien_size, self.settings.alien_size))
    ...
    def _check_keyup_events(self, event):
        if event.key == pygame.K_RIGHT or event.key == pygame.K_d: #Stop move right
            self.ship.moving_right = False
        elif event.key == pygame.K_LEFT or event.key == pygame.K_a: #Stop move left
    ...
    def setTaskbarIcon(self):
        myappid = 'zollern.alieninvasion.test.v1' # arbitrary string
